namespace DotNetCoords
{
    ...
    public abstract class CoordinateSystem
    {
        ...
        public Datum.Datum Datum { get; private set; }

        /// <summary>
        ///     Convert a co-ordinate in the co-ordinate system to a point represented by a latitude and
        ///     longitude and a perpendicular height above (or below) a reference ellipsoid.
        /// </summary>
