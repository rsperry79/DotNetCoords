...
{
    /// <summary>
    ///     ECEF (earth-centered, earth-fixed) Cartesian co-ordinates are used to define a point in
    ///     three-dimensional space. ECEF co-ordinates are defined relative to an x-axis (the
    ///     intersection of the equatorial plane and the plane defined by the prime meridian), a y-axis
    ///     (at 90° to the x-axis and its intersection with the equator) and a z-axis (intersecting the
    ///     North Pole). All the axes intersect at the point defined by the center of mass of the Earth.
    /// </summary>
    public class ECEFRef : CoordinateSystem
    {
        /**
         * x co-ordinate in meters.
         */

        /**
         * y co-ordinate in meters.
         */

        /**
         * z co-ordinate in meters.
         */

        /// <summary>
        ///     Create a new earth-centered, earth-fixed (ECEF) reference from the given parameters
        ...
        public ECEFRef(double x, double y, double z)
            : this(x, y, z, WGS84Datum.Instance)
        {
        }
        ...
        /// <summary>
        ///     Convert this ECEFRef object to a point represented by a latitude and longitude and a
        ///     perpendicular height above (or below) a reference ellipsoid.
        /// </summary>
        /// <returns> The equivalent latitude and longitude. </returns>
